...
<template>
  ...
  >
    <container @click="showFilter = !showFilter">
      <sprite v-bind="center" texture="bg_scene_rotate" :rotation="rotation" />
      <sprite v-bind="center" texture="light_rotate_1" :rotation="rotation * 2" />
      <sprite v-bind="center" texture="light_rotate_2" :rotation="rotation" />
      <sprite v-bind="center" texture="panda" :scale="pandaScale" />
    </container>
  </assets>
