...
Creates a [TilingSprite](https://pixijs.download/release/docs/scene.TilingSprite.html)
...
| --- | --- | --- | --- |
| texture | ^[string] ^[object]`Texture` | `undefined` | The texture to use on the TilingSprite. |
...
| --- | --- | --- |
| effect | ^[function]`(el: TilingSprite): void` | custom render function |
