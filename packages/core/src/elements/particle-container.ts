...
export type ParticleContainerProps = ExtractContainerProps<ParticleContainer, ParticleContainerOptions>

export type ParticleContainerEvents = ExtractContainerEvents<ParticleContainer>
